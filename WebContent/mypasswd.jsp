                    ...
                    <div class="col-md-6 login-form mx-auto col-xl-7">
                        ...
                        <div class="card">
                            <div class="card-header">
                                <h3 class="mb-0">查看密码</h3>
<%
	request.setCharacterEncoding("utf-8");
	//String username="root";//session.getAttribute("username").toString();
	//String sessionPassword="daf5c8a1";//session.getAttribute("sessionPassword").toString();
...
%>
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <!--<a href="Query?id=<%=pwd.getPid() %>&methodName=<%=2%>&listid=<%=i%>" ">详情</a> -->
                                            </td>
                                        </tr>
<%
			}
...
%>
                                ...
                                <div class="row mb-3">
                                    <div class="col-md-12">
                                        ...
                                        <p class="alert-danger" align="center">
                                            如表格背景变黑，请点击底部连接重新登录！<br>出于安全考虑，即使管理员也无法帮您找回密码！忘记密码只能重置账户，请牢记您的邮箱及密码！</p>
                                    </div>
                                </div>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-lg-6"><a href="userinfo.jsp"
                                            class="btn btn-info btn-wd gp btn-block"><span>我的信息</span></a></div>
                                </div>
                                <div class="row">
                                    <div class="col-lg-12">
                            ...
                            <div class="card-footer">
                                ...
                                <p><a href="login.html" class="text-black text-small">登录超时？重新登录</a></p>
                            </div>
                        </div>
                        <!-- /form card login -->
                    </div>
